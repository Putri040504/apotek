    ...
    <div class="pos-scan-bar">
        <div class="pos-scan-wrap">
            ...
            <div class="pos-scan-input-row">
                <input type="text" id="posSearch" class="pos-scan-input" placeholder="Kode barcode atau nama obat..." autocomplete="off" autofocus>
        ...
        <aside class="pos-right">
            ...
            <div class="pos-cart-footer">
                <div class="pos-total-row">
                    ...
                    <span id="posTotal" class="amount" data-value="{{ $cartTotal }}">Rp {{ number_format($cartTotal, 0, ',', '.') }}</span>
                </div>
...
setInterval(() => {
    ...
    if (el) {
        const d = new Date();
        el.textContent = d.toLocaleDateString('id-ID') + ' ' + d.toLocaleTimeString('id-ID', { hour: '2-digit', minute: '2-digit' });
    }
}, 30000);
</script>
@endsection
