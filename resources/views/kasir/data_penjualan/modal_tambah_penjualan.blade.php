                ...
                <div class="modal-body">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="harga" class="form-control form-control-sm auto-field"
                                disabled>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="kode_exp" class="form-control form-control-sm auto-field"
                                disabled>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="stok" class="form-control form-control-sm auto-field"
                                disabled>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="total" class="form-control form-control-sm auto-field"
                                disabled>
                        </div>
