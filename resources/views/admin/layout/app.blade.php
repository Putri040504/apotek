        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <ul class="nav flex-column">
                    ...
                    <li>
                        <a class="nav-link {{ request()->is('admin/pembelian*') ? 'active' : '' }}"
                    ...
                    <li>
                        ...
                        <div id="laporanMenu" class="collapse">
                            ...
                            <ul class="nav flex-column ms-3">
                                ...
                                <li>
                                    <a class="nav-link {{ request()->is('admin/laporan/obat') ? 'active' : '' }}"
                                        href="/admin/laporan/obat">
                                ...
                                <li>
                                    ...
                                    <div id="pembelianMenu" class="collapse">
                                        ...
                                        <ul class="nav flex-column ms-3">
                                            ...
                                            <li>
                                                <a class="nav-link {{ request()->is('admin/laporan/pembelian-bulanan') ? 'active' : '' }}"
                                                    href="/admin/laporan/pembelian-bulanan">
                                                    Pembelian Bulanan
                                                </a>
                                            </li>

                                            <li>
                                                <a class="nav-link {{ request()->is('admin/laporan/pembelian-jenis') ? 'active' : '' }}"
                                                    href="/admin/laporan/pembelian-jenis">
                                                    Jenis Obat
                                                </a>
                                            </li>
                                ...
                                <li>
                                    ...
                                    <div id="penjualanMenu" class="collapse">
                                        ...
                                        <ul class="nav flex-column ms-3">
                                            ...
                                            <li>
                                                <a class="nav-link {{ request()->is('admin/laporan/penjualan-bulanan') ? 'active' : '' }}"
                                                    href="/admin/laporan/penjualan-bulanan">
                                                    Penjualan Bulanan
                                                </a>
                                            </li>

                                            <li>
                                                <a class="nav-link {{ request()->is('admin/laporan/penjualan-jenis') ? 'active' : '' }}"
                                                    href="/admin/laporan/penjualan-jenis">
                                                    Jenis Obat
                                                </a>
                                            </li>
