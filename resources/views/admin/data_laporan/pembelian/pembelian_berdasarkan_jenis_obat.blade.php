    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        @if ($bulan)
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('laporan.pembelian.jenis.excel', ['bulan' => $bulan, 'tahun' => $tahun, 'obat' => $obat]) }}"
                    class="btn btn-outline-success">
                    <i class="bi bi-file-earmark-excel"></i> Excel
                </a>

                <a href="{{ route('laporan.pembelian.jenis.pdf', ['bulan' => $bulan, 'tahun' => $tahun, 'obat' => $obat]) }}"
    ...
    @if ($bulan)
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body">
                ...
                <table id="tabelPembelianJenis" class="table table-bordered table-hover table-sm text-center align-middle"
