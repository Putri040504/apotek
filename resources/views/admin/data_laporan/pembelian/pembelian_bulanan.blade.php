    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        @if ($bulan && $tahun)
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('laporan.pembelian.excel', ['bulan' => $bulan, 'tahun' => $tahun]) }}"
                    class="btn btn-outline-success">
                    <i class="bi bi-file-earmark-excel"></i> Excel
                </a>

                <a href="{{ route('laporan.pembelian.pdf', ['bulan' => $bulan, 'tahun' => $tahun]) }}"
    ...
    @if ($bulan && $tahun)
        <div class="card shadow-sm border-0">
            ...
            <div class="card-body">
                ...
                <table id="tabelPembelian" class="table table-bordered table-hover table-sm text-center align-middle"
