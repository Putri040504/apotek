                ...
                <div class="modal-body" style="font-size:14px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="kode_supplier" value="{{ $s->kode_supplier }}"
                                class="form-control bg-light" readonly>
                        </div>

                        <div class="col-md-6 mb-3">
                            <label class="form-label">Nama Supplier</label>
                            <input type="text" name="nama_supplier" value="{{ $s->nama_supplier }}"
                                class="form-control">
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="obat_id" class="form-control">
                                ...
                                @foreach ($obat as $o)
                                    <option value="{{ $o->id }}" {{ $s->obat_id == $o->id ? 'selected' : '' }}>
