...
<input type="date" name="tanggal_exp" value="{{ $o->tanggal_exp }}" class="form-control">
</div>
...
<input type="text" name="harga_beli" value="{{ $o->harga_beli }}" class="form-control rupiah">
</div>

<div class="col-md-6 mb-3">
<label class="form-label">Harga Jual</label>
<input type="text" name="harga_jual" value="{{ $o->harga_jual }}" class="form-control rupiah">
</div>
