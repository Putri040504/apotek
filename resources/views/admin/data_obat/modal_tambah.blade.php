...
<input type="date" name="tanggal_exp" value="{{ old('tanggal_exp') }}" class="form-control">
</div>
...
<input type="text" name="harga_beli" value="{{ old('harga_beli') }}" class="form-control rupiah">
</div>
